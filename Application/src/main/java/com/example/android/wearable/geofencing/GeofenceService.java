...
public class GeofenceService extends IntentService
    ...
    public static final String LOG_TAG = GeofenceService.class.getSimpleName();
...
//                }
                    Logger.i(LOG_TAG, getString(R.string.entering_geofence) + ": " + triggeredGeoFenceId);
...
//                Wearable.DataApi.deleteDataItems(mGoogleApiClient, GEOFENCE_DATA_ITEM_URI).await();
                    String triggeredGeoFenceId = geoFenceEvent.getTriggeringGeofences().get(0)
                            .getRequestId();
                    Logger.i(LOG_TAG, getString(R.string.exiting_geofence) + ": " + triggeredGeoFenceId);
...
//                mGoogleApiClient.disconnect();
            ...
            Logger.e(LOG_TAG, "onHandleIntent() error: " + e.getStackTrace().toString());
        }
    }
